...
field of view into existence. Aviary contains 4 species of birds; Bluebirds,
...
AbstractBird, so it is quite convenient that each of these characteristics 
...
forward in a zig-zag pattern. Luckily, it is intelligent enough to understand
...
in Aviary instantaneously. The reasoning behind where they decide to go is 
